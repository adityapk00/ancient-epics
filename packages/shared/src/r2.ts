...
export function buildChapterPrefix(
  bookSlug: string,
  chapterSlug: string,
): string {
...
export function buildOriginalChapterKey(
  bookSlug: string,
  chapterSlug: string,
): string {
...
export function buildTranslationsPrefix(
  bookSlug: string,
  chapterSlug: string,
): string {
...
export function buildTranslationChapterKey(
  bookSlug: string,
  chapterSlug: string,
